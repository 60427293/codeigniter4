        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Creditos</th>
                    <th>Nota final</th>
                    <th><a class='btn-primary btn-lg' href='http://localhost/codeigniter4/public/cursos'>Regresar</a></th>
                </tr>
            </thead>
            <tbody>
                <?PHP
                    foreach ($datos as $fila){
                        ...
                        echo "<td><a class='btn-warning btn-lg' href='http://localhost/codeigniter4/public/cursos/resturar/".$fila["idcurso"]."'>Restaurar</a></td>";
                        echo "</tr>";
                    }
                ?>
            <tbody>
