        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Email</th>
                    <th>Celular</th>
                    <th><a class='btn-primary btn-lg' href='http://localhost/codeigniter4/public/alumnos'>Regresar</a></th>
                </tr>
            </thead>
            <tbody>
                <?PHP
                    foreach ($datos as $fila){
                        ...
                        echo "<td><a class='btn-warning btn-lg' href='http://localhost/codeigniter4/public/alumnos/resturar/".$fila["idalumno"]."'>Restaurar</a></td>";
                        echo "</tr>";
                    }
                ?>
            <tbody>
