...
<body>
    ...
    <div class="contenedor">
        <form method="POST" action="http://localhost/codeigniter4/public/profesores/actualizar">
            ...
            <div class="input-group">
                ...
                <input id="idprofesor" name="idprofesor" type="text" class="form-control" value="<?= $datos["idprofesor"] ?>" readonly> <!--disabled no envia valores-->
            </div>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
            <input id="nombres" name="nombres" type="text" class="form-control" value="<?= $datos["nombres"] ?>" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="apellidos" class="col-4 col-form-label">Apellidos</label> 
            <div class="col-8">
            <input id="apellidos" name="apellidos" type="text" class="form-control" value="<?= $datos["apellidos"] ?>" required>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="input-group">
                ...
                <input id="email" name="email" type="email" placeholder="ejemplo@gmail.com" class="form-control" value="<?= $datos["email"] ?>" required>
            </div>
            </div>
        </div> 
        <div class="form-group row">
