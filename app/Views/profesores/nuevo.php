...
<body>
    ...
    <div class="contenedor">
        <form method="POST" action="http://localhost/codeigniter4/public/profesores/guardar">
        ...
        <div class="form-group row">
            ...
            <div class="input-group">
                ...
                <input id="email" name="email" type="email" placeholder="ejemplo@gmail.com" class="form-control" required>
            </div>
            </div>
        </div> 
        <div class="form-group row">
            <div class="offset-4 col-8">
            <button name="submit" type="submit" class="btn btn-success">Enviar datos</button>
            </div>
        </div>
        </form>
    </div>
